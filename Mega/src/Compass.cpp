...
void Turn_To_Compass_Heading()
{
    ...
    if (Compass_Target < 180) {
        ...
        while ((Compass_Heading_Degrees < Heading_Lower_Limit_Compass) ||
               ((Compass_Heading_Degrees > Heading_Upper_Limit_Compass) && (Attemps_Compass_Turn < 40) && (Bad_Reading < 5))) {
            delay(200);
            Get_Compass_Reading();
            ...
            if (((Compass_Heading_Degrees > Limit) && (Compass_Heading_Degrees < 360)) ||
                ((Compass_Heading_Degrees > 0) && (Compass_Heading_Degrees < Compass_Target))) {
                SetPins_ToTurnRight();
    ...
    if (Compass_Target >= 180) {
        ...
        while ((Compass_Heading_Degrees < Heading_Lower_Limit_Compass) ||
            ...
            if (((Compass_Heading_Degrees > Compass_Target) && (Compass_Heading_Degrees < 360)) ||
                ((Compass_Heading_Degrees > 0) && (Compass_Heading_Degrees < Limit))) {
                SetPins_ToTurnLeft();
                Serial.print(F("Spin Left"));
                Serial.print(F("|"));
                delay(100);
