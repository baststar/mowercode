...
void Motor_Action_Set_Speed(int left, int right) {
    analogWrite(PIN_ENA, right); // Change the 0 value to 10 or 20 to recuce the speed
    analogWrite(PIN_ENB, left);  // Change the 0 value to 10 or 20 to recuce the speed
}
