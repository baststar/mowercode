...
void Print_LCD_Menu_Tracking(byte LCD_Menu_Tracking) {
    ...
    if (LCD_Menu_Tracking == 2)
        lcd.print(F("Docking ON/OFF"));
    if (LCD_Menu_Tracking == 3)
        lcd.print(F("Tracking Dir"));
    if (LCD_Menu_Tracking == 4)
        lcd.print(F("Exit Point 1&2"));
    if (LCD_Menu_Tracking == 5)
        lcd.print(F("WireFind FwdBck"));
    if (LCD_Menu_Tracking == 6)
        lcd.print(F("Wheel Counter"));
    if (LCD_Menu_Tracking == 7)
        lcd.print(F(""));
...
void Activate_Menu_Option_Tracking() {
    ...
    if (Menu_Mode_Selection == 4) {
        ...
        while (Menu_Complete_Tracking == false) {
            ...
            if (!Minus_Key_X) {
                if (Set == 1) {
                    Track_Wire_Zone_1_Cycles = Track_Wire_Zone_1_Cycles - 100;
                    if (Track_Wire_Zone_1_Cycles < 1000)
                        lcd.clear();
                ...
                if (Set == 2) {
                    Track_Wire_Zone_2_Cycles = Track_Wire_Zone_2_Cycles - 100;
                    if (Track_Wire_Zone_2_Cycles < 1000)
                        lcd.clear();
                    lcd.setCursor(0, 0);
                    lcd.print(F("  Zone1:"));
                    lcd.print(Track_Wire_Zone_1_Cycles);
    ...
    if (Menu_Mode_Selection == 5) {
        ...
        while (Menu_Complete_Tracking == false) {
            ...
            if (!Minus_Key_X) {
                if (Set == 1) {
                    Max_Cycle_Wire_Find = Max_Cycle_Wire_Find - 10;
                    if (Max_Cycle_Wire_Find <= 10)
                        Max_Cycle_Wire_Find = 10; // cant be less than zero.
                    lcd.clear();
                    lcd.setCursor(0, 0);
                    lcd.print(F(">Track Fwd: "));
                    lcd.print(Max_Cycle_Wire_Find);
                ...
                if (Set == 2) {
                    Max_Cycle_Wire_Find_Back = Max_Cycle_Wire_Find_Back - 10;
                    if (Max_Cycle_Wire_Find_Back <= 10)
                        Max_Cycle_Wire_Find_Back = 10; // cant be less than zero.
                    lcd.clear();
                    lcd.setCursor(0, 0);
                    lcd.print(F(" Track Fwd: "));
                    lcd.print(Max_Cycle_Wire_Find);
    ...
    if (Menu_Mode_Selection == 6) {
        ...
        while (Menu_Complete_Tracking == false) {
            ...
            if (!Minus_Key_X) {
                if (Set == 1) {
                    Max_Tracking_Turn_Right = Max_Tracking_Turn_Right - 10;
                    if (Max_Tracking_Turn_Right <= 100)
                        Max_Tracking_Turn_Right = 100; // cant be less than zero.
                    lcd.clear();
                    lcd.setCursor(0, 0);
                    lcd.print(F(">RH Wheel: "));
                    lcd.print(Max_Tracking_Turn_Right);
                ...
                if (Set == 2) {
                    Max_Tracking_Turn_Left = Max_Tracking_Turn_Left - 10;
                    if (Max_Tracking_Turn_Left <= 100)
                        Max_Tracking_Turn_Left = 100; // cant be less than zero.
                    lcd.clear();
                    lcd.setCursor(0, 0);
                    lcd.print(F(" RH Wheel: "));
                    lcd.print(Max_Tracking_Turn_Right);
    ...
    if (Menu_Complete_Tracking = true)
