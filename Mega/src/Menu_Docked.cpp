...
void Print_LCD_Menu_Docked(byte LCD_Menu_Docked)
{
    ...
    if (LCD_Menu_Docked == 2)
        lcd.print(F("Exit Dock Z-2"));
    if (LCD_Menu_Docked == 3)
        lcd.print(F("Quick Start"));
    if (LCD_Menu_Docked == 4)
        lcd.print(F("Trampoline Cut"));
    if (LCD_Menu_Docked == 5)
        lcd.print(F("Mow the Line"));
    if (LCD_Menu_Docked == 6)
        lcd.print(F("Test Mower"));
    if (LCD_Menu_Docked == 7)
        lcd.print(F("Setup Mower"));
    if (LCD_Menu_Docked == 8)
        lcd.print(F("-- Spare 8 --"));
    if (LCD_Menu_Docked == 9)
        lcd.print(F("-- Spare 9 --"));
    if (LCD_Menu_Docked == 10)
        lcd.print(F("-- Spare 10 --"));
    if (LCD_Menu_Docked == 11)
        lcd.print(F("-- Spare 11 --"));
    if (LCD_Menu_Docked == 12)
