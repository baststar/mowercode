...
{
    if (LCD_Menu_Alarms == 1)
        lcd.print(F("Set Alarm 1"));
    if (LCD_Menu_Alarms == 2)
        lcd.print(F("Set Alarm 2"));
    if (LCD_Menu_Alarms == 3)
        lcd.print(F("Set Alarm 3"));
    if (LCD_Menu_Alarms == 4)
...
{
    if (Menu_View > Max_Options_Alarms)
        Menu_View = Menu_View - 1;
    if (Menu_View < 0)
        Menu_View = Menu_View + 1;
        ...
        while (Menu_Complete_Alarms == false) {
            ...
            if (!Start_Key_X) {
                ...
                if (Set == 3) {
                    ...
                    lcd.print(">Do: ");
                    if (Alarm_1_Action == 1)
                        lcd.print("Exit Zone 1");
                    if (Alarm_1_Action == 2)
                        lcd.print("Exit Zone 2");
                    if (Alarm_1_Action == 3)
