...
{
    if (LCD_Menu_Settings == 1)
        lcd.print(F("Alarm 1"));
    if (LCD_Menu_Settings == 2)
        lcd.print(F("Alarm 2"));
    if (LCD_Menu_Settings == 3)
        lcd.print(F("Alarm 3"));
    if (LCD_Menu_Settings == 4)
        lcd.print(F("Wheel Speed LH"));
    if (LCD_Menu_Settings == 5)
        lcd.print(F("Wheel Speed RH"));
    if (LCD_Menu_Settings == 6)
        lcd.print(F("Blade Speed"));
    if (LCD_Menu_Settings == 7)
        lcd.print(F("Compass ON/OFF"));
    if (LCD_Menu_Settings == 8)
        lcd.print(F("Compass Home deg"));
    if (LCD_Menu_Settings == 9)
        lcd.print(F("Set Clock"));
    if (LCD_Menu_Settings == 10)
        lcd.print(F("Pattern Mow"));
    if (LCD_Menu_Settings == 11)
        lcd.print(F("Battery Min"));
    if (LCD_Menu_Settings == 12)
        lcd.print(F("Tracking PID"));
    if (LCD_Menu_Settings == 13)
        lcd.print(F("**TiP**"));
    if (LCD_Menu_Settings == 14)
        lcd.print(F("SPARE"));
    if (LCD_Menu_Settings == 15)
        lcd.print(F("SPARE"));
    if (LCD_Menu_Settings == 16)
        lcd.print(F("SPARE"));
    if (LCD_Menu_Settings == 17)
        lcd.print(F("SPARE"));
    if (LCD_Menu_Settings == 18)
        lcd.print(F("CLEAR EEPROM")); // Leave Blank
    if (LCD_Menu_Settings == 19)
    ...
    if (Menu_Mode_Selection == 8) {
        ...
        while (Menu_Complete == false) {
            ...
            if (!Plus_Key_X) {
                ...
                if (Home_Wire_Compass_Heading > 360)
                    Home_Wire_Compass_Heading = 0;
                lcd.setCursor(0, 1);
            ...
            if (!Minus_Key_X) {
                Home_Wire_Compass_Heading = Home_Wire_Compass_Heading - 10;
                if (Home_Wire_Compass_Heading < 0)
                    Home_Wire_Compass_Heading = 360;
                lcd.setCursor(0, 1);
                lcd.print("      "); // Fully clear the number to stop reminants of a previous number from being left behind
                lcd.setCursor(0, 1);
                lcd.print(Home_Wire_Compass_Heading);
