...
{
    if (LCD_Menu_Sensors == 1)
        lcd.print(F("SONAR ON/OFF"));
    if (LCD_Menu_Sensors == 2)
        lcd.print(F("SONAR Distance"));
    if (LCD_Menu_Sensors == 3)
        lcd.print(F("SONAR Sensitivity"));
    if (LCD_Menu_Sensors == 4)
        lcd.print(F("Battery Min/Max")); // add max
    if (LCD_Menu_Sensors == 5)
        lcd.print(F("Batt Sensitivity"));
    if (LCD_Menu_Sensors == 6)
        lcd.print(F("WIRE ON/OFF"));
    if (LCD_Menu_Sensors == 7)
        lcd.print(F("RAIN ON/OFF"));
    if (LCD_Menu_Sensors == 8)
        lcd.print(F("Rain Sensitivity"));
    if (LCD_Menu_Sensors == 9)
        lcd.print(F("WIFI ON/OFF"));
    if (LCD_Menu_Sensors == 10)
        lcd.print(F("Bumper ON/OFF"));
    if (LCD_Menu_Sensors == 11)
        lcd.print(F(""));
...
{
    if (Menu_View > Max_Options_Sensors)
        Menu_View = Menu_View - 1;
    if (Menu_View < 0)
        Menu_View = Menu_View + 1;
...
void Activate_Menu_Option_Sensors()
{
    if (Menu_Mode_Selection == 1) {
        ...
        if (Sonar_2_Activate == 1)
            lcd.print("Y");
        if (Sonar_2_Activate == 0)
            lcd.print("N");
        lcd.print(F(" S1:"));
        if (Sonar_1_Activate == 1)
            lcd.print("Y");
        if (Sonar_1_Activate == 0)
            lcd.print("N");
        lcd.print(F(" S3:"));
        if (Sonar_3_Activate == 1)
            lcd.print("Y");
        if (Sonar_3_Activate == 0)
            lcd.print("N");
        delay(2000);
    ...
    if (Menu_Mode_Selection == 2) {
        ...
        while (Menu_Complete_Sensors == false) {
            ...
            if (!Plus_Key_X) {
                ...
                if (maxdistancesonar > 100)
                    maxdistancesonar = 100;
                lcd.clear();
                lcd.setCursor(0, 0);
                lcd.print(F("Sonar Distance:"));
                lcd.setCursor(0, 1);
    ...
    if (Menu_Mode_Selection == 5) {
        ...
        while (Menu_Complete_Sensors == false) {
            ...
            if (!Plus_Key_X) {
                ...
                if (Low_Battery_Instances_Chg > 50)
                    Low_Battery_Instances_Chg = 50;
                lcd.clear();
                lcd.setCursor(0, 0);
                lcd.print(F("Batt Sensitivity:"));
                lcd.setCursor(0, 1);
            ...
            if (!Minus_Key_X) {
                Low_Battery_Instances_Chg = Low_Battery_Instances_Chg - 1;
                if (Low_Battery_Instances_Chg < 1)
                    Low_Battery_Instances_Chg = 1;
                lcd.clear();
                lcd.setCursor(0, 0);
                lcd.print(F("Batt Sensitivity:"));
                lcd.setCursor(0, 1);
    ...
    if (Menu_Mode_Selection == 8) {
        ...
        while (Menu_Complete_Sensors == false) {
            ...
            if (!Plus_Key_X) {
                ...
                if (Rain_Total_Hits_Go_Home > 50)
                    Rain_Total_Hits_Go_Home = 50;
                lcd.clear();
                lcd.setCursor(0, 0);
                lcd.print(F("Rain Sensitivity:"));
                lcd.setCursor(0, 1);
            ...
            if (!Minus_Key_X) {
                Rain_Total_Hits_Go_Home = Rain_Total_Hits_Go_Home - 1;
                if (Rain_Total_Hits_Go_Home < 1)
                    Rain_Total_Hits_Go_Home = 1;
                lcd.clear();
                lcd.setCursor(0, 0);
                lcd.print(F("Rain Sensitivity:"));
                lcd.setCursor(0, 1);
