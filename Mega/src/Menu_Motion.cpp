...
{
    if (LCD_Menu_Motion == 1)
        lcd.print(F("Wheel Speed"));
    if (LCD_Menu_Motion == 2)
        lcd.print(F("Blade Speed")); //+need to add ON/OFF
    if (LCD_Menu_Motion == 3)
        lcd.print(F("Blades ON/OFF"));
    if (LCD_Menu_Motion == 4)
        lcd.print(F("Turn Angles"));
    if (LCD_Menu_Motion == 5)
        lcd.print(F("Reverse Dist"));
    if (LCD_Menu_Motion == 6)
        lcd.print(F("Max Length"));
    if (LCD_Menu_Motion == 7)
        lcd.print(F("Pattern Mow"));
    if (LCD_Menu_Motion == 8)
        lcd.print(F("-SPARE-"));
...
{
    if (Menu_View > Max_Options_Motion)
        Menu_View = Menu_View - 1;
    if (Menu_View < 0)
        Menu_View = Menu_View + 1;
...
void Activate_Menu_Option_Motion()
{
    ...
    if (Menu_Mode_Selection == 5) {
        ...
        while (Menu_Complete_Motion == false) {
            ...
            if (!Minus_Key_X) {
                Mower_Reverse_Delay = Mower_Reverse_Delay - 100;
                if (Mower_Reverse_Delay <= 1000)
                    lcd.clear();
                if (Mower_Reverse_Delay <= 0)
                    Mower_Reverse_Delay = 100;
                lcd.setCursor(0, 0);
                lcd.print(F("Reverse Time/ms:"));
                lcd.setCursor(0, 1);
                lcd.print(Mower_Reverse_Delay);
    ...
    if (Menu_Mode_Selection == 6) {
        ...
        while (Menu_Complete_Motion == false) {
            ...
            if (!Minus_Key_X) {
                Max_Cycles_Straight = Max_Cycles_Straight - 10;
                if (Max_Cycles_Straight < 10)
                    Max_Cycles_Straight = 10;
                lcd.clear();
                lcd.setCursor(0, 1);
                lcd.print(F("Max Loops: "));
                lcd.print(Max_Cycles_Straight);
