...
extern uint16_t eeprom_p_value;
#define EEPROM_INDEX_P_VALUE 70
...
#define EEPROM_INDEX_ZONE_1_MOWTIME 36
extern uint16_t eeprom_zone_1_mowtime;
#define EEPROM_INDEX_ZONE_2_MOWTIME 38
extern uint16_t eeprom_zone_2_mowtime;

// ALARMS
#define EEPROM_INDEX_ALARM_HOUR_1 46
extern uint16_t eeprom_alarm_hour_1;
#define EEPROM_INDEX_ALARM_MINUTE_1 48
extern uint16_t eeprom_alarm_minute_1;
#define EEPROM_INDEX_ALARM_ACTIVE_1 50
extern uint16_t eeprom_alarm_active_1;
#define EEPROM_INDEX_ALARM_SEQUENCE_1 52
extern uint16_t eeprom_alarm_sequence_1;

#define EEPROM_INDEX_ALARM_HOUR_2 54
extern uint16_t eeprom_alarm_hour_2;
#define EEPROM_INDEX_ALARM_MINUTE_2 56
extern uint16_t eeprom_alarm_minute_2;
#define EEPROM_INDEX_ALARM_ACTIVE_2 58
extern uint16_t eeprom_alarm_active_2;
#define EEPROM_INDEX_ALARM_SEQUENCE_2 60
extern uint16_t eeprom_alarm_sequence_2;

#define EEPROM_INDEX_ALARM_HOUR_3 62
extern uint16_t eeprom_alarm_hour_3;
#define EEPROM_INDEX_ALARM_MINUTE_3 64
extern uint16_t eeprom_alarm_minute_3;
#define EEPROM_INDEX_ALARM_ACTIVE_3 66
extern uint16_t eeprom_alarm_active_3;
#define EEPROM_INDEX_ALARM_SEQUENCE_3 68
